                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="input-group mb-3 mt-4">
                                        <label class="input-group-text" for="productIsActive">Apakah produk ini aktif?</label>
                                        <select class="form-select" id="productIsActive" name="is_active">
                                            <option value="1" {{ $product->is_active == 1 ? 'selected' : '' }}>Aktif</option>
                                            <option value="0" {{ $product->is_active == 0 ? 'selected' : '' }}>Menonaktifkan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="col mb-1">
                                        <label class="mb-2" for="productStock">Stok</label> <br />
                                        <div class="input-group mb-3">

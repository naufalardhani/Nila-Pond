                    ...
                    <div class="card-body px-0 pb-0">
                        <div class="table-responsive">
                            <table class='table mb-0' id="table1">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Naufal Ardhani</td>
                                        <td>naufalardhani89@gmail.com</td>
                                        <td>0812-6764-4410</td>
                                    ...
                                    <tr>
                                        <td>Ghaeril Juniawan</td>
                                        <td>ghaeriljuniawan@apps.ipb.ac.id</td>
                                        <td>0813-9082-2314</td>
                                        <td>Sukabumi</td>
                                        <td>
                                            <span class="badge bg-success">Active</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Fikri Saputri</td>
                                        <td>fikri@apps.ipb.ac.id</td>
                                        <td>0856-5315-2134</td>
                                        <td>Ciawi</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Jasmine</td>
                                        <td>jasmine@apps.ipb.ac.id</td>
                                        <td>0877-9812-4516</td>
                                        <td>Jakarta Barat Daya</td>
                                        <td>
                                            <span class="badge bg-success">Active</span>
                                        </td>
                                    </tr>
